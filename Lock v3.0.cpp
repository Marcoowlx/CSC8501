...
void w_valid(int i) {
		...
		if (new_file[i].CN[0] == new_file[i].CN[1] || new_file[i].CN[0] == new_file[i].CN[2] || new_file[i].CN[0] == new_file[i].CN[3] ||
			new_file[i].CN[1] == new_file[i].CN[2] || new_file[i].CN[1] == new_file[i].CN[3] ||
			new_file[i].CN[2] == new_file[i].CN[3])
		{
...
int main() {
	...
	for (int i = 0; i < 100; i++) {
		int ROOT = rand() % 10000;
		new_file[i].ROOT = g_root(ROOT);
		outkey_file << "NS" << i + 1 << endl;
		outkey_file << "ROOT ";
		outkey_file << new_file[i].ROOT[0] << new_file[i].ROOT[1] << new_file[i].ROOT[2] << new_file[i].ROOT[3] << endl;
		outkey_file << "UHF ";
